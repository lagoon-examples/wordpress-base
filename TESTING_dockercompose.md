...
docker ps --filter label=com.docker.compose.project=wordpress-base | grep Up | grep wordpress-base_nginx_1
docker ps --filter label=com.docker.compose.project=wordpress-base | grep Up | grep wordpress-base_mariadb_1
docker ps --filter label=com.docker.compose.project=wordpress-base | grep Up | grep wordpress-base_php_1
docker ps --filter label=com.docker.compose.project=wordpress-base | grep Up | grep wordpress-base_cli_1
...
docker-compose exec -T php sh -c "echo PD9waHAgcmVtb3ZlX2ZpbHRlcigndGVtcGxhdGVfcmVkaXJlY3QnLCAncmVkaXJlY3RfY2Fub25pY2FsJyk7 | base64 -d > /app/web/content/themes/twentytwentythree/functions.php"
